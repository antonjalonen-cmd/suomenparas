...
CATEGORY_GROUPS = [
    ...
    ("Digitaaliset palvelut", [
        ...
        ("Sähköpostipalvelut", "sahkopostipalvelut", True), ("Verkkotunnusvälittäjät", "verkkotunnusvalittajat", True),
        ("Kirjanpito-ohjelmistot", "kirjanpito-ohjelmistot", True), ("Verkkokauppa-alustat", "verkkokauppa-alustat", True),
    ]),
    ("Media ja tapahtumat", [
        ...
        ("Pelitilauspalvelut", "pelitilauspalvelut", True),
        ("Podcast-palvelut", None, False), ("Äänikirjapalvelut", "aanikirjapalvelut", True),
    ]),
    ("Koti ja asuminen", [
        ...
        ("Ikkunaremontit", "ikkunaremontit", True), ("Keittiöremontit", None, False),
    ...
    ("Auto ja liikenne", [
        ...
        ("Sähköauton latausasennukset", None, False), ("Sähköauton julkinen lataus", "sahkoautojen-lataus", True),
        ("Autoliikkeet", "autoliikkeet", True),
        ("Autohinaus", None, False), ("Moottoripyöräkorjaamot", None, False),
        ("Autotarvikeliikkeet", None, False), ("Autotarvikkeet verkossa", "autotarvikkeet-verkossa", True),
        ("Taksipalvelut", "taksipalvelut", True),
        ("Pakettipalvelut", "pakettipalvelut", True),
        ("Lentoyhtiöt", "lentoyhtiot", True),
    ]),
    ...
    ("Vapaa-aika ja muut", [
        ...
        ("Muotikaupat", "muotikaupat", True),
        ("Lomamökkivuokrauspalvelut", "lomamokkivuokraus", True),
    ]),
]
