# Extraction task — vertical `lampopumppuasentajat`
...
WHAT THIS CATEGORY MEASURES: Finnish multi-region roof renovation companies. Measures the PUBLIC site: is there any price indication or calculator, is the renovation process described step by step, are warranties and their terms stated, are heat pump materials and options described?
It does NOT measure service quality. Never score anything from inside a logged-in area.

Write EXACTLY ONE file: pipeline/extracts/lampopumppuasentajat__<slug>.json — nothing else.
...
JSON shape (all keys required):
{
 ...
 "materiaalit_kuvattu": "kylla|osittain|ei",    // Laitevaihtoehdot ja merkit kuvattu
