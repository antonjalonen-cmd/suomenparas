...
## JSON shape — pipeline/extracts/autovakuutukset__<slug>.json
{
 "slug": "<slug>",
 "fetched_ok": ["<every URL you actually loaded and read>"],
 "hintalaskuri_ilman_yhteystietoja": "kylla|osittain|ei",
 "vakuutusehdot_saatavilla": "kylla|osittain|ei",   // vakuutusehdot / tuoteseloste PDF publicly downloadable
 "omavastuu_selkeasti": "kylla|osittain|ei",        // deductible amounts stated on the public page
 "bonusjarjestelma_kerrottu": "kylla|osittain|ei",  // bonus/no-claims system explained publicly
 "kaskotasot_vertailtavissa": "kylla|osittain|ei",  // the kasko tiers compared side by side
 "y_tunnus_esilla": "kylla|osittain|ei",
 "kaskotasot": ["<the tier names THIS insurer actually uses, e.g. Liikenne, Osakasko, Täyskasko>"],
 "omavastuu_min_eur": <number|null>,                // lowest deductible publicly stated. null if unseen.
