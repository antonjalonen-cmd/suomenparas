# Extraction task — vertical `urheiluvalineketjut`
...
WHAT THIS CATEGORY MEASURES: Finnish sports and outdoor equipment retail chains. Measured from the BUYER's
perspective on the public site: are product prices visible online, are delivery methods
and COSTS stated before checkout, are return
and warranty terms publicly available, are stores and opening hours listed? Does NOT
measure product quality or selection.

Write EXACTLY ONE file: pipeline/extracts/urheiluvalineketjut__<slug>.json — nothing else.
