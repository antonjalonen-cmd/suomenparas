...
## JSON shape — pipeline/extracts/lemmikkivakuutukset__<slug>.json
{
 "slug": "<slug>",
 ...
 "korvauskatto_kerrottu": "kylla|osittain|ei",     // the ANNUAL maximum payout (vuosittainen korvauskatto) stated publicly
 "rotu_ja_ikarajat_kerrottu": "kylla|osittain|ei", // breed exclusions and age limits stated publicly
 "y_tunnus_esilla": "kylla|osittain|ei",
 "riippumaton_arvio": "kylla|osittain|ei",
 "elaimet": ["<which animals THIS insurer covers: koira, kissa, hevonen, ...>"],
 "korvauskatto_eur_vuosi": <number|null>,   // annual payout cap in euros. If several tiers, the HIGHEST. null if unseen.
