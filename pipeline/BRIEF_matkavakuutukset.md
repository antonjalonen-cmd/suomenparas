...
## JSON shape — pipeline/extracts/matkavakuutukset__<slug>.json
{
 "slug": "<slug>",
 ...
 "korvauskatot_kerrottu": "kylla|osittain|ei",   // sairaus/matkatavara payout caps stated publicly
 "rajoitukset_kerrottu": "kylla|osittain|ei",    // sport/age/risk-country/pre-existing-condition limits stated publicly
