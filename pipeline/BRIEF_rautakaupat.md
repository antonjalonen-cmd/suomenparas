# Extraction task — vertical `rautakaupat`
...
WHAT THIS CATEGORY MEASURES: Finnish national hardware/building-supply chains. Measures the PUBLIC site/webshop: are product prices visible online, are delivery methods and costs stated before checkout, are return and warranty terms public, are stores and hours listed?
It does NOT measure service quality. Never score anything from inside a logged-in area.

Write EXACTLY ONE file: pipeline/extracts/rautakaupat__<slug>.json — nothing else.
