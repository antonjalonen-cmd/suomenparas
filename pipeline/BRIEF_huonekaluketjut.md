# Extraction task — vertical `huonekaluketjut`
...
WHAT THIS CATEGORY MEASURES: Finnish furniture retail chains. Measured from the BUYER's
...
Write EXACTLY ONE file: pipeline/extracts/huonekaluketjut__<slug>.json — nothing else.
