...
- [s] varainhoito-roboneuvojat — hylätty 2.8.2026: alle 6 itsenäistä toimijaa sijoitusalustat- ja pankit-kategorioiden ulkopuolella. Alexandria ja eQ ovat ainoat erilliset varainhoitotalot; FIM sulautui S-Pankkiin 2021, Taaleri Aktiaan 2021; Evli, Mandatum, Nordnet, Nordea, OP jo mitattu muissa kategorioissa. Puhtaita roboneuvojia ei ole riittävästi Suomessa.
- [s] kotisiivouksen-tilauspalvelut — hylätty 2.8.2026: samat yhtiöt kuin siivouspalvelut-kategoriassa (Freska, Kotirinki, Keradur, Onni kotisiivous, Koti Puhtaaksi) — siivouspalvelut mittaa jo NIMENOMAAN kuluttajan kotisiivouksen; eri nimi, sama kategoria
...
- [s] hissiyhtiot — hylätty 2.8.2026: ostopäätöksen tekee aina taloyhtiön hallitus, ei yksittäinen asukas — eri asia kuin kattoremontit/ikkunaremontit joissa omakotitaloasuja on suora asiakas; b2b-luonne liian vahva kuluttajavertailuun
...
- [x] lastenvaatteiden-verkkokaupat — DUPLIKAATTIRIVI; jo julkaistu 28.7.2026 (ks. aiempi [x]-merkintä: Reima #1 74,5; 7 kauppaa)
...
- [s] optiset-verkkokaupat — hylätty 2.8.2026: kaikki 5 optikot-kategorian ketjua (Specsavers, Instrumentarium, Silmäasema, Fenno Optiikka, Synsam) myyvät jo verkossa; erillistä puhtaan verkko-optikon markkinaa Suomessa ei ole ≥6 toimijalla

- [x] pakettipalvelut — julkaistu 2.8.2026; 6 yhtiötä; Matkahuolto #1 (85,1); DHL viimeinen (38,8) — dhl.com/fi-fi on B2B-sivu, reklamaatiot ohjaavat Postille; DB Schenker → DSV tunnistettu; check_extracts 6/6 OK; SV-batch 1 kpl käännettävänä
- [x] kauneustuotteet-verkkokaupat — julkaistu 3.8.2026 (orphan-tikki; 6 yhtiötä, check_extracts 6/6 OK; Lyko #1 74,1, NordicFeel viimeinen 58,9; Bangerhead yrityssaneerauksessa; Parfym.fi ainoa jolla INCI täysin esillä; KICKS ainoa jolla sovellus; eleven.fi→nordicfeel.com SAME_COMPANY-poikkeus; SV-batch 1 kpl käännettävänä)
- [x] musiikkipalvelut — julkaistu 3.8.2026 (autopilot-tikki; 6 yhtiötä, check_extracts 6/6 OK, LH 6/6; Apple Music #1 75,3, Amazon Music viimeinen 19,7; Tidal karsittu 403-botti-esto; YouTube Music GDPR-evästemuuri=mittausaukko; Qobuz ainoa hi-res-erikoispalvelu; SV-batch 1 kpl käännettävänä)
- [x] pelitilauspalvelut — julkaistu 3.8.2026 — Apple Arcade #1 (83,8), Xbox #2 (66,9), PS Plus #3 (69,9), EA Play #4 (57,2), Nintendo #5 (53,5), Ubisoft+ #6 (33,0)
- [x] aanikirjapalvelut — julkaistu 3.8.2026 (autopilot-tikki; 6 yhtiötä, check_extracts 6/6 OK; Nextory #1 78,7, Kobo viimeinen 25,8; Cloudflare-esto Podimo; Kobo Plus ei saatavilla FI; Audible/Elisa Kirja/Fabel kuolleet)

- [x] kylpylät — julkaistu 3.8.2026; Flamingo Spa #1 (83,1) / Holiday Club viimeinen (71,9); 6 yhtiötä: Flamingo Spa, Serena, Ikaalinen Spa, Peurunka, Naantalin Kylpylä, Holiday Club Resorts; GOTCHAT: flamingo.fi SSL-mismatch (oikea: flamingospa.fi), ikaalinenresort.fi ENOTFOUND (oikea: ikaalinenspa.fi), HaVen=Holiday Club-tytäryhtiö (karsittu)
- [s] halytysjarjestelmat — hylätty 3.8.2026: vain 5 yritystä löydettiin suomenkielisellä omalla verkkosivustolla (Sector Alarm, Verisure, Yale Home, Bosch Smart Home, Somfy). Muut kandidaatit kaatuivat: Ajax Systems (ajax.systems = englanninkielinen globaali, ei fi-sivua; jälleenmyyjät suomenturvatuote.fi ym. eivät laske), Ring (ring.com/fi-fi → 404), Jablotron (jablotron.com/fi → ohjaa englanniksi). Myös tutkittiin: Nuki (→ /en), Tapo (404), EZVIZ (404), Netatmo (404), Arlo (403), Resideo (404), Securitas/Stanley (B2B). Kuluttajamarkkina on ohut — vain 2 valvontapalvelua ja 3 DIY-brändiä omilla suomalaisilla sivuilla. Alla 6-yhtiön kynnys.
- [x] lentoyhtiöt — julkaistu 3.8.2026 (6 yhtiötä: Finnair, Norwegian, Ryanair, SAS, airBaltic, Wizz Air; check_extracts 6/6 OK; Norwegian #1 73,5 / Finnair #2 70,6 / Ryanair viimeinen 28,9; SAS Cloudflare-estetty → kaikki kriteerit "ei"; easyJet karsittu — ei reittiä Suomesta 2026; 540 fi / 554 sv sivua; 69 vertailukohdetta)
- [x] kirjanpito-ohjelmistot — julkaistu 4.8.2026 (6 ohjelmistoa: Netvisor, Kitsas, Procountor, Fennoa, Lemonsoft, Holvi; check_extracts 6/6 OK; Netvisor #1 84.7 / Kitsas #2 82.8 / Holvi viimeinen 57.4; Merit Aktiva karsittu — meritaktiva.fi ohjaa passeli.fi/passelimerit eikä Passeli Oy löydy PRH:sta itsenäisenä; Lemonsoft Oyj 6. yhtiönä (pörssilistattu Nasdaq First North); 547 fi / 561 sv sivua; 70 vertailukohdetta)
- [x] kahvilaketjut — LIVE 4.8.2026. Robert's Coffee #1 (71.5) / Fazer Café viimeinen (23.0 — evästemuuri). 6 ketjua: Espresso House, Robert's Coffee, Arnolds, Fazer Café, Picnic, Coffee House. Starbucks KARSITTU (ei fi-sivua), Wayne's Coffee KARSITTU (poistui 2012). coffeehouse.fi → raflaamo.fi SAME_COMPANY lisätty. 71 kat / 554 fi / 568 sv.

- [x] muotikaupat — LIVE 4.8.2026. Boozt #1 (67,3) / Zalando viimeinen (55,1). 6 kauppaa: Boozt, Ellos, KappAhl, H&M, Cubus, Zalando. Lindex korvattu Elloksella (Lindex-hakujen parempi estotiheys). Zalando+H&M botti-estetty (Akamai/Cloudflare) → kaikki kriteerit "osittain" (mittausaukot, ei puutteita). KappAhl+Cubus React-SPA — alasivut 404 ilman JS-ajoympäristöä. 72 kat / 486 yht / 561 fi + 575 sv sivua.
- [x] sahkoautojen-lataus — LIVE 4.8.2026. Helen Lataus #1 (80,9) / Fortum Charge & Drive viimeinen (61,6). 6 yhtiötä: Helen Lataus, Recharge, K-Lataus, IONITY, ABC Lataus, Fortum Charge & Drive. Check_extracts 6/6 OK, LH 6/6. 568 sivua, 73 vertaalia.
- [x] lomamokkivuokraus — julkaistu 4.8.2026 (#1 Lomarengas 81,5 / viimeinen Huvila.net 44,2 — CGI-katkos; 6 vert: Lomarengas, Booking.com, Airbnb, Nettimökki, Mökkivuokra.fi, Huvila.net)
- [x] autotarvikkeet-verkossa — julkaistu 4.8.2026 (era 20, 6 verkkokauppaa, check_extracts 6/0 OK; ALVADI #1 74,0, EU Varaosat viimeinen 58,7; karsitut: Nettivaraosa (Alma Media C2C-ilmoitusfoorumi), Bilema (WordPress-placeholder), Mekonomen (korjaamoketju ei kuluttajaverkkokauppa); 582 fi + 596 sv sivua)
- [x] rahansiirtopalvelut — julkaistu 8.8.2026. 6 palvelua (Wise, Revolut, Western Union, MoneyGram, Paysend, Skrill), Paysend #1 (63,3), MoneyGram viimeinen (30,7).
- [x] verkkokauppa-alustat — julkaistu 8.8.2026. 5 alustaa (Shopify, WooCommerce, MyCashflow, Vilkas, Kotisivukone), Shopify #1 (70,9), Vilkas viimeinen (40,6). Sivunlaajuinen SV-korjaus: "matka- ja hotellivertailut" puuttui pohjatekstin kategorialistasta ruotsiksi (sv_cache-aukko useasta aiemmasta erästä asti) — lisätty samalla kertaa.
- [x] sahkopostipalvelut — julkaistu 8.8.2026. 6 palvelua (Google Workspace, Fastmail, Zoner, Zoho Mail, Proton Mail, Tuta), Zoner #1 (78,7, ainoa suomalainen — Y-tunnus+osoite etusivulla, hinta+tuki suomeksi), Tuta viimeinen (49,4). Zoho/Proton/Tuta piilottavat maksullisten tasojen hinnat JS:n taakse (hinta_esilla=ei), Google/Fastmail/Zoner näyttävät suoraan.
- [x] verkkotunnusvalittajat — julkaistu 8.8.2026 (5. ja viimeinen "5 lisää" -erän kategoria). 6 välittäjää (Zoner, Louhi, Domainhotelli, Dynadot, Porkbun, one.com), Zoner #1 (85,2, ainoa jolla sekä 1. vuoden että uusimishinta avoimesti + Y-tunnus + suomenkielinen tuki), one.com viimeinen (54,0, kattava suomenkielinen tuki mutta ei yhtään euromääräistä hintaa). Uusi mittari "uusimishinta_kerrottu" (2. vuoden hinta) — vain Zoner+Dynadot näyttävät sen numeroina.
