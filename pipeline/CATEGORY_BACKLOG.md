...
- [~] kylpylät — kandidaatit: Holiday Club Resorts (holidayclubresorts.com; ketju useilla paikkakunnilla: Saariselkä, Tampereen Kehräämö, Vierumäki), Serena Vesimaailma (serena.fi), Flamingo Spa (flamingo.fi), Ikaalisten kylpylä (ikaalinenresort.fi), Yyterin kylpylä (yyterin-kylpyla.fi), HaVen Ylläs (haven-yllas.fi). Vertailu: päivälippu, perhepalvelut, kylpylä- ja saunaosastot, hotellipaketit, sijaintiketjut. Tarkista: onko HaVen itsenäinen yhtiö vai Holiday Club -tytäryhtiö (jos sama konserni, tarvitaan 7. vaihtoehto kuten Rauhan kylpylä tai Saariselkä Inn).
- [ ] halytysjarjestelmat — kandidaatit: Sector Alarm (sectoralarm.fi), Verisure (verisure.fi), Ajax Systems (ajaxsystems.com/fi), Yale (yale-locks.fi tai yalelock.fi), Ring/Amazon (ring.com/fi), Jablotron (jablotron.com/fi). Vertailu: kuukausihinta, sopimuspituus, laitteiden hinta, valvontakeskus, asennus DIY vs ammattilainen. Huom: tarkista Wayne's-tyyppinen bränditilanne — Verisure on entinen Securitas Direct.
