...
- [~] lentoyhtiöt — kandidaatit: Finnair (finnair.com), Norwegian (norwegian.com/fi), Ryanair (ryanair.com/fi), easyJet (easyjet.com/fi), Wizz Air (wizzair.com/fi), SAS/Scandinavian (flysas.com/fi). Kaikki lennättävät Suomesta säännöllisillä reiteillä. Vertailu: hintamuodostuksen läpinäkyvyys, lisämaksujen esittäminen, matkatavarat, lojaaliohjelmat, peruutusehdot. Huom: kaikki globaaleja yhtiöitä — tarkista onko fi-kieliset sivut olemassa ja toimivatko ne mittaukseen.
- [ ] kirjanpito-ohjelmistot — kandidaatit: Procountor (procountor.com), Netvisor (netvisor.fi, Visma Solutions Oy), Merit Aktiva (meritaktiva.fi), Fennoa (fennoa.com), Holvi (holvi.com/fi), Kitsas (kitsas.fi). Pk-yritysten taloushallinto-ohjelmistot joita yrittäjät valitsevat itse. Vertailu: hintalista näkyvillä, ilmainen kokeilujakso, suomenkielinen tuki, integraatiot, Y-tunnus (kaikilla pitäisi olla suomalainen). Huom: saman omistajan brändit SAME_COMPANY-poikkeuksella (Visma omistaa Netvisorin).
- [ ] kahvilaketjut — kandidaatit: Espresso House (espressohouse.com/fi; 65+ toimipaikkaa), Robert's Coffee (robertscoffee.com; 38 toimipaikkaa), Arnolds (arnolds.fi; 30+ toimipaikkaa), Picnic (picnic.fi; usea toimipaikka paakaupunkiseudulla+), Fazer Cafe (fazer.fi/ravintolat, useita Fazer-kahvilapaikkoja). 6. kandidaatti tarkistettava: Coffee House (HOK-Elanto/SOK-ketju?) tai Starbucks Finland (starbucks.com — tarkista fi-kielinen sivu). Wayne's Coffee KARSITTU: poistui Suomesta 2012.
