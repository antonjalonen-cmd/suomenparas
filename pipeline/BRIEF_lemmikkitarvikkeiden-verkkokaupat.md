# Extraction task — vertical `lemmikkitarvikkeiden-verkkokaupat`
...
WHAT THIS CATEGORY MEASURES: Finnish online retailers. Measured from the BUYER's
...
Write EXACTLY ONE file: pipeline/extracts/lemmikkitarvikkeiden-verkkokaupat__<slug>.json — nothing else.
